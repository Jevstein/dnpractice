 ...
 *
 *  注：请用chrome浏览器打开websocket_client.html，经测
 *    360浏览器无效。
 */
#include <stdio.h>
#include <string.h>
...
//compile:
// $ gcc -o ../../bin/websocket_server websocket_server.c -lssl
// $ gcc -o ../../bin/websocket_server websocket_server.c -lcrypto